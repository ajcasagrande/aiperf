...
class BasePayload(BaseModel):
    ...
    # literal.
    message_type: Literal[MessageType.UNKNOWN]
...
"""This is a discriminated union of all the payload types that can be sent and received.
