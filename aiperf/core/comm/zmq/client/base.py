...
from aiperf.core.comm.zmq.meta import (
    ZMQClientMetaclass,
)
from aiperf.core.error import CommChannelError, CommStateError
...
class BaseZMQClient(ABC, metaclass=ZMQClientMetaclass):
    ...
    This class provides a shared interface for all ZMQ clients in the AIPerf
    ...
    def socket(self) -> zmq.asyncio.Socket:
        ...
        Raises:
            CommStateError: If the client is not initialized
        """
        if not self._socket:
            raise CommStateError("ZMQ socket not initialized")
        return self._socket
    ...
    def _ensure_initialized(self) -> None:
        ...
        Raises:
            CommStateError: If the communication channels are not initialized.
        """
        if not self.is_initialized:
            raise CommStateError("ZMQ socket not initialized")
        if self.is_shutdown:
            raise CommStateError("ZMQ socket shutdown")
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            raise CommChannelError("Failed to initialize ZMQ socket") from e
    ...
    async def shutdown(self) -> None:
        ...
        try:
            ...
            raise CommChannelError("Failed to shutdown ZMQ socket") from e
        ...
        try:
            ...
            raise CommChannelError("Failed to cleanup ZMQ socket") from e
