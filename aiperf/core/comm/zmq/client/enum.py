...
from aiperf.core.enum import DataTopic, StrEnum, Topic, TopicType
from aiperf.core.error import CommStateError
...
class PubClientType(StrEnum):
    ...
    def from_topic(cls, topic: TopicType) -> "PubClientType":
        ...
        match topic:
            ...
            case _:
                raise CommStateError(f"No client type found for topic {topic}")
