...
class LoadGeneratorConfig(BaseConfig):
    ...
    concurrency: Annotated[
        ...
        cyclopts.Parameter(name=("--concurrency")),
    ...
    request_rate: Annotated[
        ...
        cyclopts.Parameter(name=("--request-rate")),
    ...
    request_count: Annotated[
        ...
        cyclopts.Parameter(name=("--request-count", "--num-requests")),
    ...
    warmup_request_count: Annotated[
        ...
        cyclopts.Parameter(name=("--warmup-request-count", "--num-warmup-requests")),
