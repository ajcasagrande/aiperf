...
class MetricsPreviewMessage(BaseServiceMessage):
    """Message from the records manager to show a preview of the metrics for the profile run."""

    message_type: MessageTypeT = MessageType.METRICS_PREVIEW

    metrics: list[MetricResult] = Field(..., description="The metrics to preview.")
