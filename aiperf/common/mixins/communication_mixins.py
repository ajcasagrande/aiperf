...
from aiperf.common.decorators import attrs
from aiperf.common.enums.command_enums import CommandResponseStatus
...
# class CommunicationMixin2(AIPerfLifecycleMixin):
#     """Mixin that provides an interface to the communication layer."""
...
class RequestHandlerMixin(CommunicationMixin):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.router_clients: dict[
            CommunicationClientAddressType, ReplyClientProtocol
        ] = {}
        super().__init__(
            service_config=service_config,
            **kwargs,
    ...
    def _create_router_clients(self) -> None:
        """Create the router clients for the request handlers."""
        self.router_clients[
            CommunicationClientAddressType.DATASET_MANAGER_PROXY_BACKEND
        ] = self.comms.create_reply_client(
            CommunicationClientAddressType.DATASET_MANAGER_PROXY_BACKEND,
        )  # type: ignore
    ...
    def _register_request_handlers(self) -> None:
        ...
        for message_type, handlers in getattr(
            ...
            for handler in handlers:
                ...
                self.router_clients[
                    CommunicationClientAddressType.DATASET_MANAGER_PROXY_BACKEND
                ].register_request_handler(self.service_id, message_type, handler)
...
#     async def push_inference_results(self, message: RequestRecord) -> None:
