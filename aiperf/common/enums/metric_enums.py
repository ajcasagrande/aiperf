...
@dataclass
class MetricInfo:
    """Information about a metric. This is automatically generated by the MetricRegistry."""

    type: "MetricType"
    header: str
    unit: "MetricUnitT"
    display_unit: "MetricUnitT | None"
    flags: "MetricFlags"
    value_type: "MetricValueType"
    required_metrics: set["MetricTagT"] | None


class MetricTag(CaseInsensitiveStrEnum):
    """List of pre-defined metric tags.

    This is a convenience enum that provides a more type-safe way to get the info for a metric,
    such as the unit, flags, and value type. However, metrics can be defined and used
    without being in this enum.
    """
    ...
    OSL = "osl"
    OUTPUT_INFERENCE_SPEED = "output_inference_speed"
    ...
    # Override the __new__ method to store the Pydantic `MetricInfo` model as an attribute. This is a python feature that
    ...
    def __new__(cls, tag: str) -> Self:
        ...
        obj._info: MetricInfo = None  # type: ignore
        return obj

    @cached_property
    def info(self) -> MetricInfo:
        """Get the info for the metric tag."""
        return self._info  # type: ignore

    @cached_property
    def unit(self) -> "MetricUnitT":
        """Get the unit for the metric."""
        return self.info.unit

    @cached_property
    def type(self) -> "MetricType":
        """Get the type for the metric."""
        return self.info.type

    @cached_property
    def display_unit(self) -> "MetricUnitT | None":
        """Get the display unit for the metric."""
        return self.info.display_unit

    @cached_property
    def flags(self) -> "MetricFlags":
        """Get the flags for the metric."""
        return self.info.flags

    @cached_property
    def header(self) -> str:
        """Get the header for the metric."""
        return self.info.header

    @cached_property
    def required_metrics(self) -> set["MetricTag"] | None:
        """Get the required metrics for the metric."""
        return self.info.required_metrics

    @cached_property
    def value_type(self) -> "MetricValueType":
        """Get the value type for the metric."""
        return self.info.value_type
