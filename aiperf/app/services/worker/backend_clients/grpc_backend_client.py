...
from aiperf.app.services.worker.backend_clients.base_backend_client import (
    BaseBackendClient,
)
from aiperf.common.enums.inference_enums import BackendClientType
from aiperf.common.factories.backend_client_factory import (
    BackendClientFactory,
)
from aiperf.common.models.backend_clients.backend_client_models import (
    BackendClientConfig,
)
from aiperf.common.models.backend_clients.grpc_models import (
...
class GrpcBackendClient(BaseBackendClient):
    ...
    def parse_response(self, response: GrpcResponse) -> Any:
        # TODO: Implement
        raise NotImplementedError(
