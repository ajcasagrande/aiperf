...
@ServiceManagerFactory.register(ServiceRunType.ASYNC_SUBPROCESS)
class AsyncSubprocessServiceManager(BaseServiceManager, MessageBusClientMixin):
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__(
            ...
            service_config,
            user_config,
            id="async_subprocess_service_manager",
            **kwargs,
        )
