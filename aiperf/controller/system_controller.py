...
class SystemController(SignalHandlerMixin, BaseService):
    ...
    async def _handle_signal(self, sig: int) -> None:
        ...
        if self.system_state in (SystemState.PROFILING, SystemState.PROCESSING_RESULTS):
    ...
    async def _cancel_profiling(self) -> None:
        ...
        self.system_state = SystemState.CANCELLING
        self.info("Cancelling profiling of all services")
    ...
    async def _stop_system_controller(self) -> None:
        ...
        self.debug("Sending shutdown command to all services")
