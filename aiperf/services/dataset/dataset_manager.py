...
from aiperf.common.decorators import request_handler
...
from aiperf.common.mixins.communication_mixins import RequestHandlerMixin
...
class DatasetManager(BaseComponentService, RequestHandlerMixin):
    """
    ...
    async def _initialize(self) -> None:
        ...
        # Request handlers are now automatically registered via @request_handler decorators
