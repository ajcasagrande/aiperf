...
class BaseServiceManager(ABC):
    ...
    def service_map(self) -> dict[ServiceType, list[ServiceRunInfo]]:
        ...
        result = {}
        for service_type in self.registry.all_service_types():
            services = self.registry.services_by_type(service_type)
    ...
    def service_id_map(self) -> dict[str, ServiceRunInfo]:
        ...
        result = {}
        for service_id in self.registry.all_service_ids():
