...
from aiperf.core.message.payload import CommandPayload
from aiperf.core.shared.decorator import on_run


class BaseControllerService(BaseService):
    """Base class for all controller services, such as the System Controller.

    This class provides a shared interface for all controller services in the AIPerf
