...
from aiperf.core.error import StateError
from aiperf.core.message.model import (
    CommandMessage,
    HeartbeatMessage,
    RegistrationMessage,
    StatusMessage,
)
from aiperf.core.message.payload import (
    HeartbeatPayload,
    RegistrationPayload,
    StatusPayload,
)
from aiperf.core.shared.decorator import AIPerfHooks, aiperf_task, on_run, on_set_state
...
class BaseComponentService(BaseService):
    ...
    This class provides a shared interface for all Component services in the AIPerf
    ...
    async def _on_run(self) -> None:
        ...
        try:
            ...
            raise CommError("Failed to subscribe to command topic") from e
        ...
        try:
            ...
            raise StateError("Failed to register service") from e
    ...
    async def send_heartbeat(self) -> None:
        ...
        try:
            ...
            raise StateError("Failed to send heartbeat") from e
