...
This runner deploys AIPerf System Controller as a pod in a Kubernetes cluster
and monitors its execution from the local CLI.
"""
...
class KubernetesDeploymentRunner(BaseDeploymentRunner):
    """Runs AIPerf in Kubernetes by deploying System Controller as a pod."""
    ...
    async def stop(self) -> None:
        """Stop the Kubernetes deployment."""
        # For Kubernetes, stopping means cleaning up resources
        await self._cleanup_namespace()
