...
from aiperf.app.services.dataset_manager.manager import DatasetManager
from aiperf.core.base.base_service import BaseService
from aiperf.core.enum import ServiceType
from aiperf.tests.base_test_component_service import BaseTestComponentService
from aiperf.tests.helpers import async_fixture
...
class TestDatasetManager(BaseTestComponentService):
    ...
    This test class extends BaseTestComponentService to leverage shared
