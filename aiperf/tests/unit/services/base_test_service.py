...
from aiperf.core.base.base_service import BaseService
...
from aiperf.core.service.enum import ServiceRunType
from aiperf.tests.helpers import async_fixture, async_noop
...
class BaseTestService(ABC):
    ...
    This class provides shared test methods and fixtures for testing
    ...
    def patch_communication_factory(
        ...
        """
        with patch(
            "aiperf.core.comm.communication_factory.CommunicationFactory.create_communication",
